/**
 * @fileoverview System module compliant with the <a
 *               href="http://wiki.commonjs.org/wiki/System/1.0">CommonJS
 *               System/1.0</a> specification. Additional non-standard methods
 *               for sleeping on the current thread, spawning a new thread and
 *               spawning processes are provided.
 */
require('fibers');
var io = require('./io');
