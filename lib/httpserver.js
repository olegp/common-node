...
http.IncomingMessage.prototype._addHeaderLine = function(field, values) {
  ...
  if (current === undefined) {
    ...
    dest[field] = current.concat(values);
  }
};
...
var main = exports.main = function(module, port, options) {
  ...
  if (options && options.key !== undefined && options.cert !== undefined) {
    // TODO test
    https.createServer(options, jsgi(app)).listen(port);
  } else {
    http.createServer(jsgi(app)).listen(port);
  }
