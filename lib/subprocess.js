...
var createProcess = exports.createProcess = function(args) {
  ...
  var stdin = copy(new Stream(child.stdin), new MemoryStream());
  var stdout = copy(new Stream(child.stdout), new MemoryStream());
  var stderr = copy(new Stream(child.stderr), new MemoryStream());
