 ...
 * <a href="http://wiki.commonjs.org/wiki/Binary/B">CommonJS Binary/B</a>.
 */
...
var zeroArray = [];
for (var i = 0; i < 128; i ++) zeroArray.push(0);
 ...
 * is returned.
 * 
 * The constructor also accepts a <a href="http://nodejs.org/docs/v0.4.8/api/buffers.html#buffers">Node.js Buffer</a>.
 * 
 ...
 *
 * @param {Binary|Array|String|Number|Buffer} contentOrLength content or length of the ByteArray.
...
var ByteArray = exports.ByteArray = function() {
  ...
  // ByteArray(string, charset) - convert a string - the ByteArray will contain string encoded with charset
...
Binary.prototype.toArray = function(charset) {
    if (charset) {
        return Array.prototype.map.call(
                this.buffer.toString(encodings[charset]),
                function(x) {
 ...
 * @function
 */
ByteString.prototype.split = function(delimeter, options) {
    ...
    var delimiters = delimiters.map(function(delimiter) {
