/**
 * @fileoverview Stream and TextStream classes as per <a
 *               href="http://wiki.commonjs.org/wiki/IO/A">CommonJS IO/A</a> as
 *               well as a ByteArray based in memory MemoryStream.
 */
 ...
 * @param stream
 *          a <a
 *          href="http://nodejs.org/docs/v0.4.8/api/streams.html#streams">Node.js
 *          Stream</a> that can be readable, writeable or both
 */
 ...
 * @param {Object}
 *          [thisObj] optional this-object to use for callback
 */
 ...
 * @param {Binary}
 *          source The source to be written from
 * @param {Number}
 *          begin optional
 * @param {Number}
 *          end optional
...
Stream.prototype.write = function(source, begin, end) {
	// TODO do we support non Binary sources
	if(begin || end) {
 ...
 * 
 * @param {Stream}
 *          output The target Stream to be written to.
 */
 ...
 * the stream is writable, its internal buffer will automatically on demand.
 * 
 * @param {Binary|number}
 *          bufferOrCapacity the buffer to use, or the capacity of the buffer to
 *          allocate . If this is a number, a ByteArray with the given length is
 *          allocated. If this is a ByteArray, the resulting stream is both
 *          readable, writable, and seekable. If this is a ByteString, the
 *          resulting stream is readable and seekable but not writable. If
 *          undefined, a ByteArray of length 1024 is allocated as buffer.
 * @constructor
 */
var MemoryStream = exports.MemoryStream = function MemoryStream(
	...
	stream.write = function(source, begin, end) {
		...
		if(typeof source === "string") {
			system.stderr
					.print("Warning: binary write called with string argument. Using default encoding");
 ...
 * 
 * @param {Stream}
 *          io The raw Stream to be wrapped.
 * @param {Object}
 *          options the options object. Supports the following properties:
 *          <ul>
 *          <li>charset: string containing the name of the encoding to use.
 *          Defaults to "utf8".</li>
 *          <li>newline: string containing the newline character sequence to
 *          use. Defaults to "\n".</li>
